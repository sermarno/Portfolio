...
export default function ResumePage() {
  return (
    <main>
      <div className="max-w-5xl mx-auto px-6 py-5 bg-[#2e2e2e] rounded-xl m-3">
        <div className="relative flex items-center w-full px-4">
          ...
          <a
            ...
            className="ml-auto inline-flex items-center text-white bg-[#4a4a4a] px-4 py-2 rounded-lg border border-[#2a2a2a] hover:bg-[#3a3a3a] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-in-out"
          >
          ...
          <div className="max-w-6xl w-full">
            <div className="flex justify-center space-x-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex text-white text-sm items-center hover:bg-[#3a3a3a] hover:px-4 hover:py-2 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-in-out"
              >
                <Github size={28} />
          ...
          <div className="flex justify-center py-4">
            ...
            <div className="px-3 py-4 ml-9">
              ...
              <p>
                ...
                devices, improve digital intuition with modernized technology,
                and utilize UX research and design principals to identify user
                needs, build low to high-fidelity prototypes, and develop clean,
                effective code for user-centered intuitive interfaces.
              </p>
              <a
                href="/projects"
                rel="noopener noreferrer"
                className="inline-flex flex-col items-center justify-center text-white bg-[#fb5bbf] px-4 py-2 mt-3 rounded-lg hover:bg-[#d63d9d] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-in-out"
              >
